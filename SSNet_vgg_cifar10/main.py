...
parser.add_argument('--gpu_id', default='5,1,2', type=str,
...
channel_len = [3, 64, 64, 128, 128, 256, 256, 256, 512, 512, 512, 512, 512, 512, 10]
...
def main():
    ...
    for epoch in range(args.start_epoch,args.num_epochs):
        ...
        if is_best:
            ...
            if args.layer_id == 12 and epoch == args.num_epochs - 1:
                copy_model = 'results/models/copy_model.pth'
                torch.save(model, copy_model)
