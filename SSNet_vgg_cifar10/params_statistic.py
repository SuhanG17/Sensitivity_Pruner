...
parser.add_argument('--gpu_id', default='1, 4, 6', type=str,
...
def main():
    ...
    model = torch.nn.DataParallel(model.to(device), device_ids=[0,1,2])
...
#             summary(model, input_size=(ch, h, w), batch_size = n)
